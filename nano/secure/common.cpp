...
char const * live_public_key_data = "A74A1816A896B4FB9846D52E301F5235EEF182186ED784755C3D66C3EEB42215"; // xrb_3t6k35gi95xu6tergt6p69ck76ogmitsa8mnijtpxm9fkcm736xtoncuohr3
...
char const * dev_genesis_data = R"%%%({
	...
	"representative": "btc_3e3j5tkog48pnny9dmfzj1r16pg8t1e76dz5tmac6iq689wyjfpiij4txtdo",
	"account": "btc_3e3j5tkog48pnny9dmfzj1r16pg8t1e76dz5tmac6iq689wyjfpiij4txtdo",
...
char const * beta_genesis_data = R"%%%({
	...
	"representative": "btco_1betagoxpxwykx4kw86dnhosc8t3s7ix8eeentwkcg1hbpez1outjrcyg4n1",
	"account": "btco_1betagoxpxwykx4kw86dnhosc8t3s7ix8eeentwkcg1hbpez1outjrcyg4n1",
...
char const * live_genesis_data = R"%%%({
	"type": "open",
	"source": "A74A1816A896B4FB9846D52E301F5235EEF182186ED784755C3D66C3EEB42215",
	"representative": "btc_3btc51dcj7onzge6fobg81ho6fhgy833iupqijtorhd8rhqdaaiond6hyndp",
	"account": "btc_3btc51dcj7onzge6fobg81ho6fhgy833iupqijtorhd8rhqdaaiond6hyndp",
	"work": "b467584481c873a2",
	"signature": "D7CB3F42665CBEAEED97B93C360E78E6DF2EB0010BEC039A32A5DE8BBE47706612F90B9174F4329A51F88FAB1AAA42D0422B412B769762EBA3559E8EC88F5D0B"
    })%%%";
...
std::string const test_genesis_data = nano::get_env_or_default ("NANO_TEST_GENESIS_BLOCK", R"%%%({
	...
	"representative": "btco_1jg8zygjg3pp5w644emqcbmjqpnzmubfni3kfe1s8pooeuxsw49fdq1mco9j",
	"account": "btco_1jg8zygjg3pp5w644emqcbmjqpnzmubfni3kfe1s8pooeuxsw49fdq1mco9j",
...
nano::network_params::network_params (nano::networks network_a) :
	work{ network_a == nano::networks::nanobitcoin_live_network ? nano::work_thresholds::publish_full : network_a == nano::networks::nanobitcoin_beta_network ? nano::work_thresholds::publish_beta
		: network_a == nano::networks::nanobitcoin_test_network                                                                                        ? nano::work_thresholds::publish_test
...
nano::ledger_constants::ledger_constants (nano::work_thresholds & work, nano::networks network_a) :
	...
	genesis (network_a == nano::networks::nanobitcoin_dev_network ? nanobitcoin_dev_genesis : network_a == nano::networks::nanobitcoin_beta_network ? nanobitcoin_beta_genesis
	: network_a == nano::networks::nano_test_network                                                                           ? nanobitcoin_test_genesis
																															   : nanobitcoin_live_genesis),
	...
	final_votes_canary_account (network_a == nano::networks::nanobitcoin_dev_network ? nano_dev_final_votes_canary_account : network_a == nano::networks::nanobitcoin_beta_network ? nano_beta_final_votes_canary_account
	: network_a == nano::networks::nanobitcoin_test_network                                                                                                                 ? nano_test_final_votes_canary_account
	...
	final_votes_canary_height (network_a == nano::networks::nanobitcoin_dev_network ? nano_dev_final_votes_canary_height : network_a == nano::networks::nanobitcoin_beta_network ? nano_beta_final_votes_canary_height
																																								   ...
																																								   : nano_live_final_votes_canary_height)
{
	...
	auto error (nano_live_epoch_v2_signer.decode_account ("btco_3qb6o6i1tkzr6jwr5s7eehfxwg9x6eemitdinbpi7u8bjjwsgqfj4wzser3x"));
	debug_assert (!error);
	auto epoch_v2_signer (network_a == nano::networks::nanobitcoin_dev_network ? nano::dev::genesis_key.pub : network_a == nano::networks::nanobitcoin_beta_network ? nano_beta_account
