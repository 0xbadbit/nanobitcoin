...
public:
	...
	/** Set account from an btc_ or nano_ address */
	...
	/** Set representative from an btc_ or nano_ address */
	...
	/** Set link from an btc_ or nano_ address */
...
public:
	...
	/** Set destination from an btc_ or nano_ address */
