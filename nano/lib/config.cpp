...
0xfffffc0000000000,
0xffffffe000000000, // 8x higher than epoch_1
...
{
	auto test_env = get_env_or_default ("NANO_TEST_MAGIC_NUMBER", "BC");
...
{
	nano::network_constants::set_active_network (nano::networks::nanobitcoin_dev_network);
}
