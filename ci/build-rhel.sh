...
run_build() {
    ...
    case "${NETWORK}" in
	  "LIVE")
	  	scl enable gcc-toolset-12 'rpmbuild --nodebuginfo -ba nanobitcoin.spec'
	  	;;
	  "BETA")
	  	scl enable gcc-toolset-12 'rpmbuild -ba nanobitcoin-beta.spec'
	  	;;
	  *)
